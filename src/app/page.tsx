    ...
    return (
      <main className={styles.welcomePage}>
        <section className={styles.welcomeCard}>
          ...
          <h1>열두 동물 놀이터</h1>
          <p>로그인하고 동물 친구들이 준비한<br />12개의 미니게임을 만나보세요.</p>
    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.ticket}>
          <span>오늘의 자유이용권</span><strong>12 GAMES</strong><small>원하는 동물 우리를 선택하세요</small>
        </div>
      </section>
      ...
      <section className={styles.gameSection} aria-labelledby="game-list-title">
        <div className={styles.sectionHeading}>
          ...
          <p><strong>1</strong>개 오픈 · <strong>11</strong>개 준비 중</p>
        </div>
